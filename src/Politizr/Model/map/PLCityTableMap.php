...
class PLCityTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('PUReactionPLCity', 'Politizr\\Model\\PUReactionPLC', RelationMap::ONE_TO_MANY, array('id' => 'p_l_city_id', ), 'CASCADE', 'CASCADE', 'PUReactionPLCities');
        ...
        $this->addRelation('PUReactionPUser', 'Politizr\\Model\\PUser', RelationMap::MANY_TO_MANY, array(), 'CASCADE', 'CASCADE', 'PUReactionPUsers');
