...
abstract class BasePUserArchivePeer
{
    ...
    const ORGANIZATION = 'p_user_archive.organization';
    ...
    const SUPPORT_GROUP = 'p_user_archive.support_group';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PUserArchivePeer::ORGANIZATION);
            ...
            $criteria->addSelectColumn(PUserArchivePeer::SUPPORT_GROUP);
