...
abstract class BasePCircleArchive extends BaseObject implements Persistent
{
    ...
    public function setPublicCircle($v)
    {
        ...
        if ($this->public_circle !== $v) {
            ...
            $this->modifiedColumns[] = PCircleArchivePeer::PUBLIC_CIRCLE;
        }
    ...
    public function setOpenReaction($v)
    {
        ...
        if ($this->open_reaction !== $v) {
            ...
            $this->modifiedColumns[] = PCircleArchivePeer::OPEN_REACTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 19; // 19 = PCircleArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PCircleArchivePeer::PUBLIC_CIRCLE)) {
            $modifiedColumns[':p' . $index++]  = '`public_circle`';
        }
        if ($this->isColumnModified(PCircleArchivePeer::OPEN_REACTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PCircleArchivePeer::PUBLIC_CIRCLE)) $criteria->add(PCircleArchivePeer::PUBLIC_CIRCLE, $this->public_circle);
        if ($this->isColumnModified(PCircleArchivePeer::OPEN_REACTION)) $criteria->add(PCircleArchivePeer::OPEN_REACTION, $this->open_reaction);
